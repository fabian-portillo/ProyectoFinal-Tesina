        ...
        <section class="seccion contenedor">
            ...
            <form id="registro" class="registro" action="pagar.php" method="post">
                ...
                <div id="paquetes" class="paquetes">
                  <h3>Elige el Paquete de tu preferencia (Mensual)</h3>
                  <ul class="lista-precios clearfix">
                      <li>
                            <div class="tabla-precio">
                                <h3>Estancia de Verano (2 meses)</h3>
                                <p class="numero">$2200</p>
                                <ul>
                                  <li>Habitación compartida</li>
                                  <li>Todos los servicios básicos</li>
                                  <li>Limpieza 1 día por semana</li>
                                </ul>
                                <div class="orden">
                                    <label for="pase_dia">Total de inquilinos:</label>
                      ...
                      <li>
                            <div class="tabla-precio">
                                <h3>Semestre de Intercambio (4-6 meses)</h3>
                                <p class="numero">$2200 - $3100 </p>
                                <ul>
                                  <li>Habitación individual o compartida</li>
                                  <li>Desayuno incluido</li>
                                  <li>Agua, luz, gas e internet incluido</li>
                                </ul>
                                <div class="orden">
                                    <label for="pase_completo">Total de inquilinos:</label>
                      ...
                      <li>
                            <div class="tabla-precio">
                                <h3>Estancia mayor a 1 año</h3>
                                <p class="numero">$2300</p>
                                <ul>
                                  <li>Habitación individual</li>
                                  <li>Patio con cochera</li>
                                  <li>Agua, luz, gas e internet incluido.</li>
                                </ul>
                                <div class="orden">
                                    <label for="pase_dosdias">Total de inquilinos:</label>
                ...
                <div id="eventos" class="eventos clearfix">
                         <h3>Elige tus caracteristicas</h3>
                         <div class="caja">
                                <?php
                                    try {
                     ...
                     <div id="resumen" class="resumen">
                        ...
                        <div class="caja clearfix">
                              <div class="extras">
                                    <div class="orden">
                                        <label for="camisa_evento">Camiseta de UdG $10 <small>(promocion 7% dto.)</small></label>
                                        <input type="number" min="0" id="camisa_evento" name="pedido_extra[camisas][cantidad]" size="3" placeholder="0">
                                        <input type="hidden" value="10" name="pedido_extra[camisas][precio]">
                                    </div> <!--.orden-->
                                    <div class="orden">
                                        <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(Leones Negros)</small></label>
